...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Habit.archived'
        db.add_column(u'habits_habit', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Habit.archived'
        db.delete_column(u'habits_habit', 'archived')
    ...
    models = {
        ...
        u'habits.habit': {
            'Meta': {'ordering': "['archived', '-start']", 'object_name': 'Habit'},
