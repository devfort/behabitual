...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Bucket', fields ['index', 'resolution', 'habit']
        db.create_unique(u'habits_bucket', ['index', 'resolution', 'habit_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bucket', fields ['index', 'resolution', 'habit']
        db.delete_unique(u'habits_bucket', ['index', 'resolution', 'habit_id'])
