...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Habit.description'
        db.add_column(u'habits_habit', 'description',
                      self.gf('django.db.models.fields.TextField')(default='wibble'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Habit.description'
        db.delete_column(u'habits_habit', 'description')
