...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bucket.resolution'
        db.alter_column(u'habits_bucket', 'resolution', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Bucket.resolution'
        db.alter_column(u'habits_bucket', 'resolution', self.gf('django.db.models.fields.IntegerField')())
