...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Habit.reminder_last_sent'
        db.add_column(u'habits_habit', 'reminder_last_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Habit.reminder_last_sent'
        db.delete_column(u'habits_habit', 'reminder_last_sent')
    ...
    models = {
        ...
        u'habits.habit': {
            ...
            'reminder_last_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'resolution': ('django.db.models.fields.CharField', [], {'default': "u'day'", 'max_length': '10'}),
