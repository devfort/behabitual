...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Habit'
        db.create_table(u'habits_habit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='habits', to=orm['accounts.User'])),
            ('resolution', self.gf('django.db.models.fields.CharField')(default='day', max_length=10)),
        ))
        db.send_create_signal(u'habits', ['Habit'])


    def backwards(self, orm):
        # Deleting model 'Habit'
        db.delete_table(u'habits_habit')
